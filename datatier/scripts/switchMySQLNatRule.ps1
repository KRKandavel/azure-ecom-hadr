...
Set-AzureRmContext -SubscriptionId cc52d2b2-77d2-45ff-aec9-da553c829eef
...
$nic0=Get-AzureRmNetworkInterface -Name $dns-nic$from -ResourceGroupName $rg
$nic1=Get-AzureRmNetworkInterface -Name $dns-nic$to -ResourceGroupName $rg
